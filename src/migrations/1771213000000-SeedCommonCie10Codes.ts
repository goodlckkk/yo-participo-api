...
const cie10Codes = [
  ...
  { codigo: 'E87', descripcion: 'Otros trastornos del equilibrio hidroelectrolítico y del equilibrio acidobásico' },
  ...
  { codigo: 'F17', descripcion: 'Trastornos mentales y del comportamiento debidos al uso de tabaco' },
  ...
  { codigo: 'G54', descripcion: 'Trastornos de las raíces y de los plexos nerviosos' },
  ...
  { codigo: 'H52', descripcion: 'Trastornos de la refracción y de la acomodación' },
  ...
  { codigo: 'J06', descripcion: 'Infecciones agudas de las vías respiratorias superiores, múltiples y no especificadas' },
  ...
  { codigo: 'K52', descripcion: 'Otras gastroenteritis y colitis no infecciosas' },
  ...
  { codigo: 'O23', descripcion: 'Infección del tracto geniturinaro en el embarazo' },
  { codigo: 'O26', descripcion: 'Atención materna por otras afecciones predominantemente relacionadas con el embarazo' },
  { codigo: 'O86', descripcion: 'Otras infecciones puerperales' },

  // Ciertas afecciones originadas en el período perinatal (P00-P96)
  { codigo: 'P07', descripcion: 'Trastornos relacionados con la gestación corta y el bajo peso al nacer' },
  { codigo: 'P22', descripcion: 'Sufrimiento respiratorio del recién nacido' },
  { codigo: 'P59', descripcion: 'Ictericia neonatal debida a otras causas y a las no especificadas' },
  ...
  { codigo: 'R19', descripcion: 'Otros síntomas y signos que afectan el sistema digestivo y el abdomen' },
  { codigo: 'R20', descripcion: 'Trastornos de la sensibilidad cutánea' },
  { codigo: 'R21', descripcion: 'Erupción y otras erupciones no especificadas' },
  ...
  { codigo: 'R63', descripcion: 'Síntomas y signos concernientes a la ingestión de alimentos y líquidos' },
  { codigo: 'R73', descripcion: 'Aumento de la glucemia' },
  { codigo: 'R74', descripcion: 'Aumento de las transaminasas y de la deshidrogenasa láctica' },
  { codigo: 'R79', descripcion: 'Otros hallazgos anormales de la química sanguínea' },
  ...
  { codigo: 'S13', descripcion: 'Luxación, esguince y torcedura de las articulaciones y de los ligamentos del cuello' },
  ...
  { codigo: 'S93', descripcion: 'Luxación, esguince y torcedura de las articulaciones y de los ligamentos al nivel del tobillo y del pie' },
  { codigo: 'T14', descripcion: 'Lesión de partes no especificadas del cuerpo' },
  { codigo: 'T40', descripcion: 'Envenenamiento por narcóticos y psicodislépticos' },
  { codigo: 'T46', descripcion: 'Envenenamiento por agentes que actúan primariamente sobre el sistema cardiovascular' },
  ...
  { codigo: 'Z00', descripcion: 'Examen general e investigación de personas sin quejas o diagnóstico informado' },
  { codigo: 'Z01', descripcion: 'Otros exámenes e investigaciones especiales de personas sin quejas o diagnóstico informado' },
  { codigo: 'Z03', descripcion: 'Observación y evaluación médica por sospecha de enfermedades y afecciones' },
  { codigo: 'Z11', descripcion: 'Examen especial de detección de enfermedades infecciosas y parasitarias' },
  { codigo: 'Z12', descripcion: 'Examen especial de detección de neoplasias' },
  { codigo: 'Z13', descripcion: 'Examen especial de detección de otros trastornos y enfermedades' },
  { codigo: 'Z23', descripcion: 'Necesidad de inmunización contra una sola enfermedad bacteriana' },
  ...
  { codigo: 'Z59', descripcion: 'Problemas relacionados con la vivienda y las circunstancias económicas' },
  { codigo: 'Z63', descripcion: 'Otros problemas relacionados con el grupo primario de apoyo, incluidas las situaciones familiares' },
  { codigo: 'Z71', descripcion: 'Personas que consultan por otras circunstancias' },
  { codigo: 'Z76', descripcion: 'Personas en contacto con los servicios de salud en otras circunstancias' },
  { codigo: 'Z87', descripcion: 'Antecedentes personales de otras enfermedades y afecciones' },
  { codigo: 'Z88', descripcion: 'Antecedentes personales de alergia a medicamentos y a sustancias biológicas' },
  { codigo: 'Z95', descripcion: 'Presencia de implantes e injertos cardíacos y vasculares' },
